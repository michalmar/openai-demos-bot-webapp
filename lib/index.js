...
<html>
  ...
  <body>
    ...
    <input type="text" id="txtin1" placeholder="Enter your message here" style="width: 100%; height: 40px; font-size: 20px; border-radius: 5px; border: 1px solid darkslategrey; padding-left: 5px; background-color: rgba(70, 130, 180, .2); color: antiquewhite;">
